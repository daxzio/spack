...
class Libgpiod(AutotoolsPackage):
    ...
    version(
        "2.0.0",
        sha256="62071ac22872d9b936408e4a067d15edcdd61dce864ace8725eacdaefe23b898",
        url="https://git.kernel.org/pub/scm/libs/libgpiod/libgpiod.git/snapshot/libgpiod-2.0.tar.gz",
    )
